...
export default function BookSession({ book, onFinishSession }: BookSessionProps) {
  ...
  // Focus music tracks
  const tracks = [
    { name: "🎹 Chopin: Dạ Khúc (Nocturne)", url: "https://upload.wikimedia.org/wikipedia/commons/3/3d/Nocturne_in_E_flat_major%2C_Op._9_no._2.mp3" },
    { name: "🌸 Satie: Gymnopedie No. 2", url: "https://upload.wikimedia.org/wikipedia/commons/e/e0/Gymnopedie_No._2_%28ISRC_USUAN1100786%29.mp3" },
    { name: "☁️ Bản Nhạc Mây Trắng", url: "https://www.no-copyright-music.com/wp-content/uploads/2021/09/OnAPianoCloud.mp3" }
  ];
